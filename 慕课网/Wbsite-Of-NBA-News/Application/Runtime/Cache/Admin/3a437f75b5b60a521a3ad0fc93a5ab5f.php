...
<head>
    ...
    <meta name="description" content="NBA新闻网内容管理平台">

    <title>NBA-News后台管理平台</title>
    <!-- Bootstrap Core CSS -->
    ...
    <link rel="shortcut icon"  href="http://localhost/" type="image/x-icon" />
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  ...
  <div class="navbar-header">
    <a class="navbar-brand" >NBA-News内容管理平台</a>
  </div>
